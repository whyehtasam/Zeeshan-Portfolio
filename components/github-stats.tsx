...
export default function GitHubStats() {
  ...
  return (
    <section id="github" ref={sectionRef} className=" py-12 sm:py-20 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 fade-in">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            A snapshot of my coding activity, contributions, and open-source
            involvement.
          </p>
        </div>
          ...
          <Card className="bg-gradient-to-r from-gray-900/80 to-gray-800/80 border-cyan-400/30 max-w-2xl mx-auto">
            <CardContent className="pt-6">
              ...
              <p className="text-gray-400 mb-4">
                Check out my repositories, contributions, and open-source
                projects on GitHub.
              </p>
              <a
