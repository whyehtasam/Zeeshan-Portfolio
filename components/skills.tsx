...
const skillCategories = [
  {
    ...
    skills: ["TensorFlow", "PyTorch", "Scikit-learn", "OpenCV", "Keras", "Hugging Face"],
  },
  {
    icon: Code,
  ...
  },
  {
    ...
    skills: ["Pandas", "NumPy", "Apache Spark", "Hadoop", "MongoDB", "PostgreSQL"],
  },
  {
    icon: BarChart,
  ...
  },
  {
    ...
    skills: ["AWS", "Google Cloud", "Azure", "Docker", "Kubernetes", "Terraform"],
  },
  {
    icon: Wrench,
...
const techStack = [
  ...
  { name: "Embedded Systems", level: 87, color: "from-yellow-500 to-yellow-600" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 fade-in">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            A comprehensive toolkit spanning AI/ML, data science, embedded systems, and modern development practices.
          </p>
        </div>
