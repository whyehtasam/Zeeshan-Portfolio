...
const roles = [
  ...
  },
  {
    ...
    skills: ["Predictive Modeling", "Statistical Analysis", "Data Mining", "Python", "R", "SQL"],
  },
  {
    icon: Cpu,
    title: "Embedded Systems",
    skills: ["IoT Development", "Microcontrollers", "Real-time Systems", "C/C++", "Arduino", "Raspberry Pi"],
  },
  {
    icon: BarChart3,
    title: "Business Intelligence",
    skills: ["Dashboard Development", "Data Visualization", "Tableau", "Power BI", "ETL Processes", "KPI Analysis"],
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 fade-in">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            What I{" "}
            <span className="bg-gradient-to-r from-cyan-400 to-magenta-400 bg-clip-text text-transparent">Do</span>
          </h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Transforming complex data into actionable insights through cutting-edge AI/ML solutions, embedded systems
            ...
            return (
              ...
              >
                <CardHeader className="text-center">
                  <div className="mx-auto mb-4 p-3 bg-gradient-to-r from-cyan-500/20 to-magenta-500/20 rounded-full w-fit group-hover:from-cyan-500/30 group-hover:to-magenta-500/30 transition-all duration-300">
